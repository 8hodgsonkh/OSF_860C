...
#if !defined(XMC1302_T038x0064)
#error "Unexpected MPN; expected DEVICE:=XMC1302-T038x0064. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(XMC1302_T038x0064) */
