...
static uint16_t ui16_motor_current_filtered_x5 = 0;
...
// wheel speed sensor
volatile uint16_t ui16_wheel_speed_x10 = 0;
...
uint8_t ui8_smooth_start_enabled = 0;
...
static void communications_process_packages(uint8_t ui8_frame_type)
{
	...
	switch (ui8_frame_type) {
		...
		case COMM_FRAME_TYPE_PERIODIC:
			...
			ui8_tx_buffer[5]  = (uint8_t)(ui16_battery_current_filtered_x5);
